...
При первом запуске приложения вам будет предложено ввести API ключ от OpenRouter.ai. 
После успешной проверки ключа, приложение сгенерирует 4-х значный PIN код, 
который будет использоваться для последующих входов.

- При первом входе: введите API ключ
- При последующих входах: введите PIN
- Если вы забыли PIN, используйте кнопку "Сбросить ключ" для ввода нового API ключа
